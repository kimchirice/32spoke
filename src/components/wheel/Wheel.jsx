...
const initialRimState = {
    rimName: { value: '', touched: false, hasError: true, error: '' },
    rimWeight: { value: '', touched: false, hasError: true, error: '' },
    rimERD: { value: '', touched: false, hasError: true, error: '' },
    offsetSpokeBed: {
        value: '',
        touched: false,
        hasError: true,
...
const initialSpokeState = {
    spokeName: { value: '', touched: false, hasError: true, error: '' },
    spokeWeight: { value: '', touched: false, hasError: true, error: '' },
    numberOfSpokes: { value: '32', touched: false, hasError: true, error: '' },
    lacingPatternLeft: {
        value: '0',
        touched: false,
        hasError: true,
...
const Wheel = () => {
    ...
    const calculatorWheelWeight = () => {
        const wheelWeightUpdate =
            ...
            parseFloat(
                spokeState.spokeWeight.value * spokeState.numberOfSpokes.value
            )
            ...
            <form>
                ...
                {currentStep === 1 && (
                    <Hub
                        ...
                        handleBlur={handleHubBlur}
                        hub={hubState}
                    />
                )}
                {currentStep === 2 && (
                    <Rim
                        handleChange={handleRimChange}
                        handleBlur={handleRimBlur}
                        rim={rimState}
                    />
                )}
                {currentStep === 3 && (
                    <Spoke
                        handleChange={handleSpokeChange}
                        handleBlur={handleSpokeBlur}
                        spoke={spokeState}
                    />
                )}
                {currentStep === 4 && (
